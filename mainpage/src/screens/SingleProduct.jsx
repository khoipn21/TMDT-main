...
const SingleProduct = ({ history, match }) => {
  const pdfStyle = {
    content: {
      ...
      alignItems: "center",
      width: "auto", // You can set this to the width of your PDF or leave it as auto
      maxHeight: "90vh", // This ensures the modal doesn't exceed the viewport height
      overflowY: "auto",
    },
  };
  const labels = {
  ...
  function nextPage() {
    if (pageNumber < maxPage) changePage(1);
    else {
      alert("You've reached the limit of pages you can read.");
    }
  }
  useEffect(() => {
